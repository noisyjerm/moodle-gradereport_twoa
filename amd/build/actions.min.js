...
/**
   ...
   */(Ajax),_notification=(obj=_notification)&&obj.__esModule?obj:{default:obj};_exports.init=()=>{document.querySelector("input.gradetransfer").addEventListener("change",updateStatus)};const updateStatus=evt=>{let el=evt.target,gradeid=el.dataset.gradeid;el.disabled="disabled",Ajax.call([{methodname:"gradereport_twoa_manualstatus",args:{id:gradeid},done:function(){el.disabled=!1},fail:_notification.default.exception}])}}));
